  ...
  return (
    <div className="container mx-auto px-6 py-20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <h2
            className="text-4xl md:text-5xl font-bold text-schronix-grey-800 mb-6 animate-gradient-x bg-gradient-to-r from-schronix-primary via-schronix-secondary to-schronix-accent bg-clip-text text-transparent"
            data-testid="text-team-header"
          >
            Meet Our Team
          </h2>
          <p
            className="text-xl text-schronix-grey-600 max-w-2xl mx-auto animate-fade-in-up"
            data-testid="text-team-description"
            style={{ animationDelay: "0.3s" }}
          >
            The brilliant minds behind Schronix, dedicated to
            revolutionizing student academic planning
          </p>
        </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <h3
              className="text-2xl font-semibold text-schronix-grey-700"
              data-testid="text-team-leader-section"
            >
              Team Leader
            </h3>
          </div>
              ...
              <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 max-w-sm" data-testid="card-team-leader">
                <CardContent className="p-8 text-center">
                  ...
                  <h4
                    ...
                    data-testid="text-team-leader-name"
                  >
                    {teamMembers[0].name}
                  </h4>
                  <p
                    className="text-schronix-grey-600 mb-4"
                    data-testid="text-team-leader-description"
                  >
        ...
        <div className="mb-8">
          <div className="text-center mb-8">
            <h3
              className="text-2xl font-semibold text-schronix-grey-700"
              data-testid="text-team-members-section"
            >
              Team Members
            </h3>
          </div>
                ...
                >
                  <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <CardContent className="p-8 text-center">
                      ...
                      <h4
                        className="text-lg font-bold text-schronix-grey-800 mb-2"
